        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('daftarLomba.update', $daftarLomba->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_lomba') is-invalid @enderror"
                                    name="nama_lomba" value="{{ $daftarLomba->nama_lomba }}" placeholder="Masukkan Nama Lomba">    
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control @error('sampul_lomba') is-invalid @enderror"
                                    name="sampul_lomba" value="{{ $daftarLomba->sampul_lomba }}">   
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('deskripsi_lomba') is-invalid @enderror"
                                    name="deskripsi_lomba" value="{{ $daftarLomba->deskripsi_lomba }}" placeholder="Masukkan Deskripsi Lomba">                
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('biaya_pendaftaran') is-invalid @enderror"
                                        name="biaya_pendaftaran" value="{{ $daftarLomba->biaya_pendaftaran }}" placeholder="Masukkan Biaya Pendaftaran">                     
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control @error('batas_pendaftaran') is-invalid @enderror"
                                    name="batas_pendaftaran" value="{{ $daftarLomba->batas_pendaftaran }}" placeholder="Masukkan Batas Pendaftaran">
