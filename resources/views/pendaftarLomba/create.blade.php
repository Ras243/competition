        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('pendaftarLomba.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('instansi') is-invalid @enderror"
                                    name="instansi" value="{{ old('instansi') }}" placeholder="Masukkan Instansi">
                            ...
                            <div class="form-group">
                                ...
                                <!-- error message untuk bukti_pembayaran -->
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('status_pendaftar') is-invalid @enderror"
                                    ...
                                    <option value="Lunas" {{ old('status_pendaftar') == 'Lunas' ? 'selected' : '' }}>
                                        Lunas</option>
                                    <option value="Belum Lunas"
                                        {{ old('status_pendaftar') == 'Belum Lunas' ? 'selected' : '' }}>
                                        Belum Lunas</option>
                                </select>
